...
- Docs(docs/hyperparameter_tuning.md): list items simplified. [Aditya
  NG]
- Docs(docs/): mkdocs image updates. [Aditya NG]
...
- Bump actions/setup-python from 4 to 5. [dependabot[bot]]
  ...
  - dependency-name: actions/setup-python
    ...
    update-type: version-update:semver-major
  ...
- Merge branch 'main' of https://github.com/AdityaNG/nD_VQ_VAE into
  main. [Aditya NG]
...
- Bump actions/checkout from 3 to 4. [dependabot[bot]]
  ...
  - dependency-name: actions/checkout
    ...
    update-type: version-update:semver-major
  ...
- Docs(docs/): mkdocs. [Aditya NG]
- Fix(nd_vq_vae/utils.py): removed sk-video dependency. [Aditya NG]
- Docs(README.md): setup instructions. [Aditya NG]
- Tests(tests/): coverage increased. [Aditya NG]
- Feat(scripts/train_video.py): video training working. [Aditya NG]
